...
function (_React$Component) {
  ...
  _createClass(Index, [{
    ...
    __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.mark(function _callee2() {
      var url, res, json, urlnd, resnd, jsonnd, result, data;
      return __WEBPACK_IMPORTED_MODULE_0__babel_runtime_regenerator___default.a.wrap(function _callee2$(_context2) {
        while (1) {
          switch (_context2.prev = _context2.next) {
            case 0:
              __WEBPACK_IMPORTED_MODULE_4_axios___default.a.get('${BASE_URL}/currentprice.json').then(function (response) {
                console.log("kkk", response.data.bpi);
              });
              url = "https://api.coindesk.com/v1/bpi/currentprice.json";
              _context2.next = 4;
            ...
            case 7:
              json = _context2.sent;
              urlnd = "https://api.coindesk.com/v1/bpi/currentprice/CNY.json";
              _context2.next = 11;
              return fetch(urlnd);

            case 11:
              resnd = _context2.sent;
              _context2.next = 14;
              return resnd.json();

            case 14:
              jsonnd = _context2.sent;
              result = {
                key: dateFormat(new Date(), "h:MM:ss TT")
              };
              Object.keys(json.bpi).map(function (item) {
              ...
              Object.keys(jsonnd.bpi).map(function (item) {
...
//# sourceMappingURL=4.67cf3fe0a8ba26f6bcb0.hot-update.js.map